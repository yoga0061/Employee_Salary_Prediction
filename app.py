    ...
    <div class="footer">
        <div style="max-width: 800px; margin: 0 auto;">
            <div style="display: flex; justify-content: center; gap: 2rem; margin-bottom: 1rem;">
                <div>
                    <h4 style="color: var(--primary); margin-bottom: 0.5rem;">AI Salary Insights Pro</h4>
                    <p style="color: var(--dark-subtext); margin: 0; font-size: 0.9rem;">Advanced income prediction tool</p>
                </div>
                <div>
                    <h4 style="color: var(--primary); margin-bottom: 0.5rem;">Connect</h4>
                    <div style="display: flex; gap: 1rem;">
                        <a href="https://www.linkedin.com/in/yoganandha-banavathu-a02092305/" target="_blank" style="color: var(--primary-light);">LinkedIn</a>
                        <a href="https://yoga0061.github.io/portfolio/" target="_blank" style="color: var(--primary-light);">Portfolio</a>
                        <a href="mailto:yoganandha@example.com" style="color: var(--primary-light);">Email</a>
                    </div>
                </div>
            </div>
""", unsafe_allow_html=True)
